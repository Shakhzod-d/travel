...
const ContactSection = () => {
  return (
    <section className="bg-[#f5f9fa] pt-20 pb-24">
      <Container className="flex gap-10 max-[1015px]:flex-col items-end">
        <div className="flex-col justify-start gap-4 flex">
          <div className="px-5 py-2.5 bg-[#eaecf9] rounded justify-start items-center gap-2.5 inline-flex mb-4 max-w-[183px] w-[max-content]">
            <p className="text-[#635aff] text-xl font-semibold uppercase leading-normal tracking-widest max-[690px]:text-sm">
              CONTACT US
            </p>
          </div>
          <div className="flex-col justify-center gap-5 flex">
            <div className="self-stretch text-[#0c141d] text-6xl font-semibold leading-[78px] mb-5 max-[690px]:text-3xl">
        ...
        <img src="/icons/arrow.svg" alt="" className="max-[1015px]:hidden" />
