...
const Hero = () => {
    return (
        <div style={{ backgroundImage: `url(${hero})` }} className='h-[900px] padding md:h-[600px] sm:h-[300px] w-full flex flex-col items-center justify-between pt-[220px] md:pt-[100px] sm:pt-[30px] pb-11 sm:pb-5 bg-cover bg-center bg-no-repeat'>
            ...
            <div className='w-full flex justify-end'>
                <div className='flex sm:flex-col w-1/2 sm:w-full sm:items-center justify-between items-center'>
                    ...
                    <ul className='flex mr-0 sm:mt-3'>
                        {
