    ...
    <div className="flex flex-col items-center w-full">
      ...
      <div className="w-full">
        ...
        <div className={`justify-center ${screenSize ? "hidden" : "flex"}`}>
          <button
            onClick={goBack}
            className="w-[40px] h-[40px] flex justify-center items-center text-xl text-white text-semibold bg-black rounded-full mr-2"
          >
            {<GrFormPreviousLink style={{ fontSize: 22, fontWeight: 600 }} />}
          </button>
          <button
            onClick={goForward}
            className="w-[40px] h-[40px] flex justify-center items-center text-xl  text-white text-semibold bg-black rounded-full"
          >
