...
const Tours = () => {
    ...
    let uniqueCategory = [...new Set(data?.results.map((item: CategoryType) => item.title ))];
    return (
        <div>
            <HeaderAbout
                ...
                </div>
                {
                    isLoading ? (
                        ...
                        <div className="w-full flex sm:flex-col justify-between">
                            <select name="categoryOptions" id="category" className="max-w-[600px] w-full rounded-lg px-2 py-4 outline-none bg-[#F5F5F5] font-semibold">
                                {
                            ...
                            <select name="locationOptions" id="location" className="max-w-[600px] w-full rounded-lg px-2 py-4 outline-none bg-[#F5F5F5] font-semibold">
